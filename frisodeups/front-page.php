          ...
          <?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
            ...
            <article class="p-news__item p-news-info">
              <div class="p-news-info__head">
                ...
                <div class="p-news-info__category <?php $cat = get_the_category();
                                                  $cat = $cat[0]; {
                                                    echo $cat->slug;
                                                  } ?>">
              ...
              <div class="p-news-info__body">
                <a href="<?php the_permalink(); //記事のリンクを表示 
                          ?>" class="p-news-info__text"><?php the_title(); //タイトルを表示 
                                                        ?></a><!-- /.p-news-info__text -->
    ...
    <div class="p-blog__items">
      ...
      ?>
        <?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
          ...
          <a href="<?php the_permalink(); //記事のリンクを表示 
                    ?>" class="p-blog__item  p-card js-scrollAnimation <? if ($get_time > $last) {
                                                                          echo 'p-card--new';
                                                                        } ?>">
