  ...
  <div class="l-inner p-post-news__inner">
    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <div class="p-post-news__title-bottom">
          ...
          <div class="p-post-news__category <?php $cat = get_the_category();
                                            $cat = $cat[0]; {
                                              echo $cat->slug;
                                            } ?>">
        ...
        <div class="p-post-news__body">
          <p class="p-post-news__text">
            <?php $newsTextSub = scf::get('news-text');
            echo nl2br($newsTextSub); ?>
          ...
          <p class="p-post-news__text">
            <?php $newsTextSub = scf::get('news-text-sub');
            echo nl2br($newsTextSub); ?>
          </p><!-- /.p-post-news__text -->
          ...
          <p class="p-post-news__text">
            <?php $newsTextSub = scf::get('news-text-sub2');
            echo nl2br($newsTextSub); ?>
          </p><!-- /.p-post-news__text -->
        </div><!-- /.p-post-news__body -->

        <div class="p-post-news__img2">
          <img src="<?php $newsImageSub = scf::get('news-image-sub');
                    echo wp_get_attachment_url($newsImageSub); ?>" alt="投稿サブ画像">
        </div><!-- /.p-post-news__img -->
      ...
      ?>
          ...
          <a href="<?php the_permalink(); ?>" class="p-post-news-article__item p-card">
            ...
            <div href="" class="p-card__body">
              <h3 class="p-card__title"><?php the_title(); //タイトルを表示 
                                        ?></h3><!-- /.p-card__title -->
            </div><!-- /.p-card__body -->
            <div href="" class="p-card__bottom">
              <div class="p-card__category <?php $cat = get_the_category();
                                            $cat = $cat[0]; {
                                              echo $cat->slug;
                                            } ?>">
                <?php $cat = get_the_category();
