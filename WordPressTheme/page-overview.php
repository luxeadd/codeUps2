      ...
      <dl class="p-lower-overview-body__lists">
        ...
        <div class="p-lower-overview-body__list">
           ...
           <dd class="p-lower-overview-body__text-box">
              <p class="p-lower-overview-body__text">株式会社CodeUps</p>
           </dd>
        </div><!-- / -->
        ...
        <div class="p-lower-overview-body__list">
           ...
           <dd class="p-lower-overview-body__text-box">
              <p class="p-lower-overview-body__text">テキストが入ります。</p>
           </dd>
        </div><!-- / -->
        ...
        <div class="p-lower-overview-body__list">
           ...
           <dd class="p-lower-overview-body__text-box">
              <p class="p-lower-overview-body__text">テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。</p>
           </dd>
        </div><!-- / -->
